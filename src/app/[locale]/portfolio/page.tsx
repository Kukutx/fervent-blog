...
const projects = [
  {
    title: "Aurora Interfaces",
    summary:
      "A multi-platform design system for rapid experimentation with generative visuals.",
    cover: "https://images.unsplash.com/photo-1526498460520-4c246339dccb?auto=format&fit=crop&w=900&q=80",
    year: "2024",
  ...
  },
  {
    ...
    summary:
      "A spatial storytelling experience combining maps, long-form writing and embedded media.",
    cover: "https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?auto=format&fit=crop&w=900&q=80",
    year: "2023",
    role: "UX research · Frontend development",
  },
  {
    title: "Palette Sketch",
    summary:
      "A playful color utility for designers, including Firebase powered sharing boards.",
    cover: "https://images.unsplash.com/photo-1526498460520-4c246339dccb?auto=format&fit=crop&w=900&q=80",
    year: "2022",
    role: "Creative coding · Product strategy",
  },
];
        ...
        {projects.map((project) => (
          ...
          >
            ...
            <div className="flex flex-1 flex-col gap-3 p-6">
              ...
              <p className="text-xs uppercase tracking-[0.3em] text-muted">{project.role}</p>
            </div>
          </article>
        ))}
      </div>
